...
- **C4** (customer data, personal data, secrets, API keys): never paste.
- **C3** (Yggio source, sensor firmware source, architecture, commercial terms): only in approved tools whose contracts forbid training on submitted data.
- **C2 / C1**: fine.
